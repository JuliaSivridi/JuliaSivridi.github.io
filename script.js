const translations = {
  en: {
    ...
    proj_halytys_desc: 'Self-hosted Telegram bot that monitors Finnish emergency alert websites and delivers real-time notifications for any Finnish city. Subscribe via DM or wire a Telegram channel to one or more cities. Three alert sources with automatic fallback, deduplication across sources and check cycles, emoji-coded alert types, and 7-day event history.',
    label_github: 'GitHub',
    ...
    proj_halytys_desc: 'Itse isännöity Telegram-botti, joka seuraa suomalaisia hälytysilmoitussivustoja ja toimittaa reaaliaikaiset ilmoitukset mistä tahansa suomalaisesta kaupungista. Tilaa ilmoitukset yksityisviestillä tai yhdistä Telegram-kanava yhteen tai useampaan kaupunkiin. Kolme hälytyslähde-sivustoa automaattisella varalähteiden ketjutuksella, tapahtumat deduplikoidaan lähteiden ja tarkistussyklien välillä, emoji-koodatut hälytyslajit ja 7 päivän tapahtumahistoria.',
    label_github: 'GitHub',
    label_github_web: 'GitHub Web',
    label_github_android: 'GitHub Android',
    label_live: 'Live',
